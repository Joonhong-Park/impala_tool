...
CRED_PATH = Path(os.environ.get("APPDATA", "~")) / "ImpalaTool" / "credentials.dat"
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        tk.Label(self, text="⚡ Impala Tool", bg=BG, fg=ACCENT,
